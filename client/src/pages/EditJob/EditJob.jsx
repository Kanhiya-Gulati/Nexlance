  ...
  useEffect(() => {
    const fetchJob = async () => {
      try {
        ...
        if (jobClientId !== user?._id) {
          showToast('You are not authorized to edit this job', 'error');
        ...
        setFormData({
          ...
          skills: job.skills || [],
          budgetMin: job.budget?.min || job.budgetMin || '',
          budgetMax: job.budget?.max || job.budgetMax || '',
  ...
  return (
    <div className="page-container container fade-in">
      <div className="edit-job-header">
        <div className="edit-job-header-left">
